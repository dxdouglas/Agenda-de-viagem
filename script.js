...
// textos que quebram a linha só vão funcionar com a utilização do ``

//bibliotecas e códigos de terceiros

//object {} nesse caso, as chaves {} são consideradas uma variáveL
...
const atividade = {
    nome: "Almoço",
    data: new Date("2024-05-14 10:00"),
    finalizada: false
  }
  ...
  let atividades = [
    atividade,
    {
      ...
      data: new Date("2024-05-14 14:00"),
      finalizada: false
    },
    {
      nome: 'Sessão de jogos',
      data: new Date("2024-05-14 17:00"),
      finalizada: false
    },
  ...
  //const = a informação programa será permanente, não vai sofrer nenhuma alteração.  / let = a informação pode ser alterada e sofrer variações.
  ...
  //após a anotação dos dados acima, as linhas de código podem ser deletadas da página HTML, pois agora o item está totalmente no JavaScript
